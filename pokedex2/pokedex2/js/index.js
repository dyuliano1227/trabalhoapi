...
const search_term = document.getElementById('ins-busca') 
const search_btn = document.getElementById('but-busca') 
...
const getPokemonData = async term => { 
    ...
    document.getElementById('peso').innerHTML = `PESO ${pokemon.weight}kg`
